...
class StudentParameters(BaseModel):
    ...
    last_section: List[Literal[ "Concept Definition",
        ...
        "What-if Scenarios"]] = Field(
        ...,description="List of sections that the student has completed so far in the current concept. This should be a subset of the sections defined in NextSectionChoice.schema.py. The order of the sections does not matter, but the sections should be unique and should not repeat. The last section in this list is the most recent section that the student has completed."
        )
...
class NextSectionChoice(BaseModel):
    section_name: Literal[
        ...
        ...,
        description="The next section to show, chosen as best for the student given their current parameters.Also ensure that the student has not already completed this section in the last_section list of the StudentParameters schema. If the student has already completed this section, then choose the next best section from the list that the student has not completed yet."
    )
